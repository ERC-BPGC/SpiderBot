...
ONNX_MODEL_PATH = "/media/marmot/606de469-2f76-4155-82bc-e2e657636ad7/Ritwik/mjlab_alt/sim2sim/policies/flat_3dof.onnx"  # Path to your exported ONNX model
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run 3-DOF Spiderbot sim2sim policy playback.")
    parser.add_argument(
        "--history-length",
        type=int,
