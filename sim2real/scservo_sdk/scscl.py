...
class scscl(protocol_packet_handler):
    ...
    def ReadCurrent(self, scs_id):
        scs_present_current, scs_comm_result, scs_error = self.read2ByteTxRx(scs_id, SCSCL_PRESENT_CURRENT_L)
        return self.scs_tohost(scs_present_current, 10), scs_comm_result, scs_error
